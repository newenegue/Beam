						...
						for(var i = 0; i < instagram_results.data.length; i++) {
							...
							if(result.caption){
								...
								if(caption.length == cap_length)
									caption = caption  + "...";
								if(result.videos){
									sly.add('<li><div class="image_info"><div class="image_header"><img src="' + result.user.profile_picture + '" id="avatar" ></img><cite><a href="http://instagram.com/' + result.user.username + '" target="_blank">' + result.user.username + '</a></cite> ' + time_ago + '<div class="add_to_album" data-image-ids="'+ result.id +'"></div><br><a href="' + result.videos.standard_resolution.url + '" target="_blank">Play Video</a></div><div class="image_footer"><div class="ig_caption">'+ caption +'</div><div><a class="fs"><span class="glyphicon glyphicon-fullscreen"></span></a></div></div></div><img src=' + result.images.standard_resolution.url + '></li>');
								}
								else {
									sly.add('<li><div class="image_info"><div class="image_header"><img src="' + result.user.profile_picture + '" id="avatar" ></img><cite><a href="http://instagram.com/' + result.user.username + '" target="_blank">' + result.user.username + '</a></cite> ' + time_ago + ' <div class="add_to_album" data-image-ids="'+ result.id +'"></div></div><div class="image_footer"><div class="ig_caption">'+ caption +'</div><div><a class="fs"><span class="glyphicon glyphicon-fullscreen"></span></a></div></div></div><img src=' + result.images.standard_resolution.url + '></li>');
								}
							}
							else{
								if(result.videos)
									sly.add('<li><div class="image_info"><div class="image_header"><img src="' + result.user.profile_picture + '" id="avatar" ></img><cite><a href="http://instagram.com/' + result.user.username + '" target="_blank">' + result.user.username + '</a></cite> ' + time_ago + '<div class="add_to_album" data-image-ids="'+ result.id +'"></div><br><a href="' + result.videos.standard_resolution.url + '" target="_blank">Play Video</a></div><div class="image_footer"><div><a class="fs"><span class="glyphicon glyphicon-fullscreen"></span></a></div></div></div><img src=' + result.images.standard_resolution.url + '></li>');
								else
									sly.add('<li><div class="image_info"><div class="image_header"><img src="' + result.user.profile_picture + '" id="avatar" ></img><cite><a href="http://instagram.com/' + result.user.username + '" target="_blank">' + result.user.username + '</a></cite> ' + time_ago + ' <div class="add_to_album" data-image-ids="'+ result.id +'"></div></div><div class="image_footer"><div><a class="fs"><span class="glyphicon glyphicon-fullscreen"></span></a></div></div></div><img src=' + result.images.standard_resolution.url + '></li>');
							}
